                        ...
                        <div className="col-md-4">
                            <div className="abox-4 icon-sm">
                                ...
                                <div className="abox-4-txt">
                                    ...
                                    <p>
                                    Our courses are built on reliable, up-to-date information,
                                     ensuring you receive quality education you can depend on.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-md-4">
                            <div className="abox-4 icon-sm">
                                ...
                                <div className="abox-4-txt">
                                    ...
                                    <p>
                                    Learn from experienced, certified instructors who are experts in 
                                    their fields, dedicated to guiding you every step of the way.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-md-4">
                            <div className="abox-4 icon-sm">
                                ...
                                <div className="abox-4-txt">
                                    ...
                                    <p>
                                    Enjoy unlimited access to course materials, allowing you to 
                                    revisit and learn at your own pace whenever you need.
                                    </p>
                                </div>
                            </div>
                        </div>
