...
import Demo9Courses5 from "../components/Demo9/Demo9Courses5";
import Demo9Services6 from "../components/Demo9/Demo9Services6";
import Demo9Statistic1 from "../components/Demo9/Demo9Statistic1";
...
import UserFormModal from "../components/Register/UserFormModal";
import PaymentModal from "../components/Register/PaymentModal";
import { useModal } from "../components/Register/ModalContext";
// import { useModal } from './ModalContext';
const Demo9 = () => {
  const { isUserFormModalOpen, selectedCourse } = useModal();
  return (
    <Layout footer={2}>
      <Demo9Services6 /> {/* start learning now */}
      <Demo9Statistic1 />
      <Demo9Courses5 />
      <About2 /> {/*Multiple */}
      <AboutStatistic1 />
